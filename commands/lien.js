...
module.exports = {
    ...
    execute(message) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField("<:tls:831801590184542259> Au fait, es-tu au courant qu'il existe un serveur dédié aux TechLambdaShow ?",`[Lien du serveur du TechLambdaShow](https://discord.gg/srDSrpQddN)`)
            ...
            .addField("<:email:795931203928195113> Mon email :","[contact.techlambda@gmail.com](mailto:contact.techlambda@gmail.com)")
            .setColor(0x00ffff);
